...
/**
 * Static utility methods that are helpful when dealing with hex data and byte
 * arrays.
 *
...
public class HexUtils {
    ...
    /**
     * Converts a byte array into a hex string with a given delimiter. Example:
     * Delimiter "-" results in Strings like "01-23-45".
     *
     * @param bytes
     *            the byte array
     * @param delimiter
     *            a delimiter that is placed between every two bytes
     ...
     *            the hex string
     * @param delimiter
     *            a delimiter that was placed between every two bytes
     ...
     *
     * @param value
     *            the byte created by the hex array
